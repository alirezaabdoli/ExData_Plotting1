plot4 <- function()
{
      ...
      par(mfrow = c(2, 2))
      # plot top left
      plot(hpc_subset$Time, hpc_subset$Global_active_power, ylab = "Global Active Power", xlab = "", type = "l")
      # plot top right
      plot(hpc_subset$Time, hpc_subset$Voltage, ylab = "Voltage", xlab = "datetime", type = "l")
      # plot bottom left
      ...
      # plot bottom right
      plot(hpc_subset$Time, hpc_subset$Global_reactive_power, ylab = "Global Active Power (kilowatts)", xlab = "", type = "l")
      dev.off()
}